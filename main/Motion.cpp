...
void Motion::right(){
  analogWrite(leftMotor.getEnable1_2(), 170);
...
void Motion::left(){
  ...
  analogWrite(rightMotor.getEnable1_2(), 170);
...
void Motion::stop(){
  analogWrite(leftMotor.getEnable1_2(), 255);
  analogWrite(rightMotor.getEnable1_2(), 255);
